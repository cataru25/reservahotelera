...
function getDates(days) {
  ...
  const dateToUse = today.setDate(today.getDate() + days);
...
const hotelsData = [
  {
    ...
    availabilityFrom: getDates(0),
    availabilityTo: getDates(10), // 10 days
    rooms: 11,
    city: "Buenos Aires",
    country: "Argentina",
    price: 4
  },
  {
    ...
    availabilityFrom: getDates(10), // 10 days
    availabilityTo: getDates(15), // 15 days
    rooms: 23,
    city: "Mar del Plata",
    country: "Argentina",
    price: 2
  },
  {
    ...
    availabilityFrom: getDates(5), // 5 days
    availabilityTo: getDates(15), // 15 days
    rooms: 16,
    city: "Mendoza",
    country: "Argentina",
  ...
  },
  {
    ...
    availabilityFrom: getDates(20), // 20 days
    availabilityTo: getDates(30), // 30 days
    rooms: 32,
    city: "Jujuy",
    country: "Argentina",
    price: 1
  },
  {
    ...
    availabilityFrom: getDates(0),
    availabilityTo: getDates(5), // 5 days
    rooms: 14,
    city: "Salta",
    country: "Argentina",
    price: 2
  },
  {
    ...
    availabilityFrom: getDates(15), // 15 days
    availabilityTo: getDates(30), // 30 days
    rooms: 16,
    city: "Córdoba",
    country: "Argentina",
  ...
  },
  {
    ...
    availabilityFrom: getDates(30), // 30 days
    availabilityTo: getDates(40), // 40 days
    rooms: 40,
  ...
  },
  {
    ...
    availabilityFrom: getDates(10), // 10 days
    availabilityTo: getDates(20), // 20 days
    rooms: 21,
    city: "Pucón",
    country: "Chile",
    price: 4
  ...
  },
  {
    ...
    availabilityFrom: getDates(25), // 25 days
    availabilityTo: getDates(30), // 30 days
    rooms: 4,
    city: "Colonia",
    country: "Uruguay",
